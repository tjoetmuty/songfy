  ...
  return (
    <div className="bg-black h-screen">
      <div className="bg-[#1E1E1E] rounded-md p-2 h-screen overflow-y-auto">
        <img src={previous} className=" text-white cursor-pointer w-[25px] h-[25px]" onClick={() => handleNavigate()}/>
        ...
        <div className="bg-[#0B0A0A] mt-6 rounded-md">
          ...
          {data?.tracks?.items?.map((data, index) => (
            <div key={index} className="">
              <div className="flex hover:bg-[#737373] h-[50px] hover:rounded-md gap-9 m-4 duration-200">
